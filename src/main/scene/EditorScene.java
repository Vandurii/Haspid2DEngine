...
public class EditorScene extends Scene {
    ...
    public void init() {
        ...
        for (int x=0; x < 4; x++) {
            GameObject gameObject = new GameObject("Obj" + x, new Transform(new Vector2f(x * 20 * 1.5f, 20), new Vector2f(20, 20)), 0);
        ...
        SpriteRenderer tex2 = new SpriteRenderer(new Sprite(AssetPool.getTexture(marioImagePath)));
